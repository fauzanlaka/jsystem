<?php
    ...
    $sql = "SELECT COUNT(st_id) FROM pretest WHERE type='0'";
    ...
    $sql = "SELECT s.*,p.* FROM students s INNER JOIN pretest p ON s.st_id=p.st_id WHERE type='0' ORDER BY regNumber $limit";
    $query = mysqli_query($con, $sql);
