<div class="pull-left">
    <a href="?page=setting&&settingpage=stAdd" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus-sign"></span> PENGURUSAN SABJEK</a>
</div>
...
?>
        <tr>
          ...
          <td align="left"><?= $t_fnameRumi ?> - <?= $t_lnameRumi ?></td>
